      ...
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
          ...
          <p className="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">
            Nakon odradjenog probnog testiranja i razgovora sa trenerom mozete
            izabrai jedan od ova tri paketa:
          </p>
        </div>
        <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
            <h3 className="mb-4 text-2xl font-semibold">Polu-individualni</h3>
            <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
              Treniraj zajedno sa jos jednim prijateljem.
            </p>
            <div className="flex justify-center items-baseline my-8">
              <span className="mr-2 text-5xl font-extrabold">€200</span>
              <span className="text-gray-500 dark:text-gray-400">/mesecno</span>
            </div>
          ...
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white relative">
            <div className="badge badge-outline absolute top-8 right-[-13px] rotate-45 border-blue-900 text-white bg-blue-700">
              Najpopularniji
            </div>
            <h3 className="mb-4 text-2xl font-semibold">Individualni</h3>
            <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
              Treniraj sam kolko zelis i kad kog tebi odgovara.
            </p>
            <div className="flex justify-center items-baseline my-8">
          ...
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
            <h3 className="mb-4 text-2xl font-semibold">Grupni</h3>
            <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
              Treniraj u grupi od najmanje troje ljudi.
            </p>
            <div className="flex justify-center items-baseline my-8">
